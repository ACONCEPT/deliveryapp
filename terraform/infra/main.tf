...
# Public Subnets (for EC2 backend and NAT gateway)
...
# Note: Backend security group removed - using Lambda instead of EC2
...
resource "aws_security_group" "database" {
  ...
  # Note: Lambda security group is defined in lambda.tf
