...
type ApprovalHistory struct {
	...
	Action     base.ApprovalStatus  `json:"action" db:"action"`
...
type VendorWithApproval struct {
	Vendor
	ApprovalStatus      base.ApprovalStatus `json:"approval_status" db:"approval_status"`
...
type VendorApprovalStatusResponse struct {
	...
	ApprovalStatus       base.ApprovalStatus `json:"approval_status"`
